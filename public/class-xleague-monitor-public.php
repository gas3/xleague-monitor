 ...
 * @subpackage Xleague_Monitor/public
 */
...
class Xleague_Monitor_Public
{
	...
	public function enqueue_styles()
	{
		...
		wp_enqueue_style($this->plugin_name, plugin_dir_url(__FILE__) . 'css/xleague-monitor-public.css', array(), $this->version, 'all');
	}
	...
	{
		return "<div id='custom-firebase'></div>";
	}
}
